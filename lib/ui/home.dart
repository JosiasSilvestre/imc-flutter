  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        backgroundColor: Color.fromARGB(255, 255, 143, 68),
        actions: <Widget>[
          IconButton(
      ...
      body: SingleChildScrollView(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: <Widget>[
              Icon(Icons.person, size: 120, color: Color.fromARGB(255, 255, 143, 68)),
              TextFormField(
                keyboardType: TextInputType.number,
                decoration: InputDecoration(
                    labelText: "Peso (kg)",
                    labelStyle: TextStyle(color: Color.fromARGB(255, 255, 143, 68))),
                textAlign: TextAlign.center,
                style: TextStyle(color: Color.fromARGB(255, 255, 143, 68), fontSize: 25.0),
